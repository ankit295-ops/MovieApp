...
class UpcomingMoviesFragment : Fragment() {
    ...
    private lateinit var mBinding: FragmentUpcomingMoviesBinding
    ...
    override fun onCreateView(
        ...
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_upcoming_movies, container, false)
    ...
    private fun callApi() {
        viewModel.fetchMoviesList(Constants.upcomingMoviesUrl, page)
    }
